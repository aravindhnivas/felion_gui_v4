...
declare global {
  ...
  const logError: typeof import('tauri-plugin-log-api')['error']
  const logInfo: typeof import('tauri-plugin-log-api')['info']
  const logTrace: typeof import('tauri-plugin-log-api')['trace']
