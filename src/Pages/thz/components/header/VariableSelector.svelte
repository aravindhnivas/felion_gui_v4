...
{#if variable == 'time'}
    <div class="align">
        <Checkbox label="Relative population" bind:value={plots_to_include.main} />
        <Checkbox label="Signal plot" bind:value={plots_to_include.signal} />
        <Checkbox label="includeSUM" bind:value={includeSUM} />
        <Textfield class="ml-5" bind:value={$plot_colors} label="plots_colors (index)" />
        <div class="">
            <Checkbox label="Boltzmann" bind:value={plots_to_include.boltzmann} />
